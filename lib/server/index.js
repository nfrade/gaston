...
var Server = module.exports = {
  ...
  init: function(){
    ...
    Server.server.get('*', function(req, res){
      ...
      // if( Bundler.streams[fullPath] ){
      //   var wStream = fs.createWriteStream(fullPath);
      //   var streamVal = '';
      //   Bundler.streams[fullPath].on('data', function(chunk){
      //     streamVal += chunk.toString('utf8');
      //   });
      //   Bundler.streams[fullPath].on('end', function(){
      //     fs.writeFileAsync(fullPath, streamVal, 'utf8')
      //     Bundler.streams[fullPath] = null;
      //   });
        
      //   Bundler.streams[fullPath].pipe(res);
      // } else {
