...
var watcherHandler = function(dirPath, ev, fileName){console.log('event', ev);
  var isNewFile = ev === 'rename';
  switch( path.extname(fileName) ){
    case '.js':
      compiler.compileJS(dirPath, fileName, isNewFile);
      break;
    case '.less':
      compiler.compileLess(dirPath, fileName, isNewFile);
      break; 
  }
}