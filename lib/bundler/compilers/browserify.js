...
var Compiler = module.exports = {
  ...
  compile: function(){ console.log('compiling from ', path.join(Bundler.dirPath, 'index.js'))
    ...
    var promise =  new Promise(function(fulfill, reject){
      ...
      b.on('file',function(a,b,c){
        console.log('file!',a,b,c)
      })
...
var setSelfAlias = function(){
  ...
  basePath.pop();
  basePath = basePath.join(path.sep) + path.sep;

  var aliases = {};
  aliases[pkg.name] = basePath; console.log(aliases);
