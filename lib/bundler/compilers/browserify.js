...
var Compiler = module.exports = {
  ...
  compile: function(){
    ...
    }, config.gaston.less.options); console.log(blessifyOptions);
    ...
    for(var i = 0, len = transforms.length; i < len; i++){ console.log(transforms[i].path);
    ...
    if(Watcher.watchify && !config.isBuilding){
