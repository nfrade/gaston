...
var Compiler = module.exports = {
  ...
  compile: function(){
    ...
    Compiler.browserify.transform( lessify, { global: true, paths: [config.basePath] } );
...
var injectPackageJSON = function(wStream){
  Watcher.addWatcher(config.pkgPath);
...
var setSelfAlias = function(){
  ...
  aliases['~'] = config.basePath; console.log(aliases);
  ...
  var rebaseTransform = require('./rebase-transform');
  Compiler.browserify.transform( rebaseTransform, { global: true, aliases: aliases } );
};
