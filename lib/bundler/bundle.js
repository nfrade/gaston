...
var bundle = module.exports = function bundle(){
  ...
  if(self.watchify){
    return new Promise(function(resolve, reject){
      var onComplete = onBundleComplete(self.blessify, resolve, reject);
  ...
  return new Promise(function(resolve, reject){    
    ...
    var bundle;
    var onComplete = onBundleComplete(blessify, resolve, reject);
    bundle = self.watchify.bundle( onComplete );
    bundle.on( 'data', smapify.buildMaps );
  });
};

var onBundleComplete = function(blessify, resolve, reject){
