var log = require('npmlog')
  ...
  , StackParser = require('../log/stack-parser')
...
var Bundler = module.exports = {
  ...
  compile: function(){
    return new Promise(function(fulfill, reject){
      ...
      jsStream.on('data', StackParser.buildMaps);
      ...
      function onEndBundleHandler(){ console.log(StackParser.smaps); StackParser.reset();

        SocketServer.smcPromise = SocketServer.readSourceMaps(sourcemapPath);
