var log = require('npmlog')
  ...
  , gastonBrowserCode = require('./compile-gaston-client');
  ...
  compile: function(){
    return new Promise(function(fulfill, reject){
      ...
      if(!config.isBuilding) {
        ...
        // gastonBrowserCode().on('close', function() {
        //   console.log('gaston done!')
        // })

        // var gastonBrowserCode = fs.readFileSync( path.join(__dirname, '/../browser/gaston-compiled.js') )

        console.log('has gastoncode', gastonBrowserCode && gastonBrowserCode.length )
        //settings dev === true 

        // jsWriteStream.write( gastonBrowserCode )

        jsWriteStream.write( ';gaston.run = function() {' )

        jsStream.on('end', function() {
          console.log('done reading!')     
          jsWriteStream.write( ';gaston.run = null;};') 
        })

        jsWriteStream.on('close', function() {
          console.log('closed stream')
        })

        jsWriteStream.on( 'close', onEndBundleHandler );
