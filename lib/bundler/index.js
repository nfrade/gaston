...
var Bundler = module.exports = {
  ...
  setup: function(options){
    ...
    Bundler.pkg = require( pkgPath );
    var basePath = pkgPath.split(path.sep);
    basePath.pop();
    Bundler.basePath = basePath.join(path.sep); console.log('Bundler.inited', Bundler.injectPackage)
  },
  ...
  addCssObject: function(file, cssObj){
    ...
    Bundler.Watcher && Bundler.Watcher.addWatcher(cssObj.cssPath);
  },
