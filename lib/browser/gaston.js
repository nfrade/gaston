var io = require('socket.io-client')
  ...
  , sourceMapsPromise = new Promise(function(fulfill, reject){
      var xhr = new XMLHttpRequest();
      xhr.open('GET', 'bundle.js.map');
      xhr.onload = function(ev){
        fulfill( new sourceMap.SourceMapConsumer( JSON.parse(this.responseText) ) );
      };
      xhr.send();
    });

console.info('source-maps', sourceMap);
...
function runApplication(){
  ...
  console.log('fetching bundle.js.map');
}
