...
var ui = module.exports = {
  ...
  init: function(){
    if( !package.gaston['no-dev-button'] ){
      createMainButton(); 
    }
  }
};
...
var createMainButton = function(){
  var style = 'line-height:40px;text-align:center;border-radius:20px;min-width:40px;min-height:40px;background-color:black;color:white;display:inline-block;font-size:2.2em;margin:40px;position:absolute;z-index:99';
